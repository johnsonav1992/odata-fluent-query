export interface ComputeExpression {
   ...
   */
  as<TAlias extends string>(alias: TAlias): ComputeExpressionWithAlias<TAlias, this>
}

export interface ComputeExpressionWithAlias<TAliasKey extends string, TAliasValue> {
  toString(): string
